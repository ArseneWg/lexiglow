...
const OFFLINE_PRONUNCIATION_LIMIT = 5000;
const EXTRA_WORDS = [
...
const highFrequencyWords = lexicon
  .split(/\r?\n/)
  .map((line) => line.trim().toLowerCase())
  .filter(Boolean)
  .slice(0, OFFLINE_PRONUNCIATION_LIMIT);
const wanted = new Set(highFrequencyWords);
...
const revision = "cmudict:" + CMUDICT_REVISION + ";britfone:" + BRITFONE_REVISION + ";top:" + OFFLINE_PRONUNCIATION_LIMIT;
const output = [
...
console.log(
  "Generated pinned pronunciation fallback for top " + OFFLINE_PRONUNCIATION_LIMIT +
  " words (+ edge cases): " + Object.keys(us).length + " US and " + Object.keys(uk).length + " UK headwords.",
);
